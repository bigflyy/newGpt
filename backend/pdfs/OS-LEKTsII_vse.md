...
**Сборка при загрузке.** Исходная информация для загрузчика, объединяющего модули (совокупность модулей + дополнительны данные): 
...
ОС осуществляет загрузку/выгрузку заданий целиком после начальнeой загрузки в процессе выполнения смеси заданий. Стратегия позволяет избирательно загружать задания с целью увеличения загрузки всех компонент вычислителя. Основной недостаток – внешняя фрагментация (пустоты памяти между заданиями недостаточного размера для загрузки других заданий). 
...
В качестве ID-задачи может выступать АДРЕС ТС (значение РТС). 
...
Для выбора адресуемого объекта при такой трехкомпонентной ссылке нужно 3 цикла обращения к памяти (в таблицу сегментов за адресом таблицы страниц, в таблицу страниц за адресом страницы с адресуемым объектом, в страницу за значением адресуемого 
...
|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|ЦП1<br>ЦП2<br>ЦПm|Память<br>Ввод-вывод|Память<br>Ввод-вывод|Память<br>Ввод-вывод|Память<br>Ввод-вывод|Память<br>Ввод-вывод|Память<br>Ввод-вывод|
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
|ХОЗЯИН|||Подчиненный<br>|||Подчиненный<br>|||Приложения|||Устройства|||
|ОС+ПП|||ПП|||ПП||||||ввода-<br>вывода|||
||||||||||||||||
||||||||||||||||
||||||||||Код ОС||||||
||||||||||||||||
...
**----- Start of picture text -----**<br>
      ЦП1     ЦП2      ЦПm  Память  Ввод-вывод<br>ОС+ПП  ОС+ПП  ОС+ПП  Приложения   Устройства<br>ввода-<br>…  вывода<br>Код ОС<br>Системная шина<br>**----- End of picture text -----**<br>
...
n – приоритетов (очередей готовых процессов), m – процессоров. 
...
m – очередей готовых процессов, m – процессоров. 
...
|**ВМ1**<br>**ВМ2**|**ВМ1**<br>**ВМ2**|**ВМ1**<br>**ВМ2**|**ВМ1**<br>**ВМ2**|**ВМ1**<br>**ВМ2**|
|---|---|---|---|---|
|<br>П|||||
||||П||
||Приложение||риложение||
||||||
||||||
||Поддержка<br>||Поддержка<br>исполнения||
||исполнения<br>программ||<br>программ||
||||||
||||||
||||||
||||||
